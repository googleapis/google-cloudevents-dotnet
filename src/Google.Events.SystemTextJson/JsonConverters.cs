...
namespace Google.Events.SystemTextJson
{
    ...
    {
        public override ulong? Read(ref Utf8JsonReader reader, BclType typeToConvert, JsonSerializerOptions options) =>
    ...
    {
        public override long? Read(ref Utf8JsonReader reader, BclType typeToConvert, JsonSerializerOptions options) =>
            reader.TokenType switch
            {
