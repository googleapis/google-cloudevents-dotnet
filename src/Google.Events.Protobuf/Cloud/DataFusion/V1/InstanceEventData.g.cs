...
{    
    ...
    public partial class InstanceEventData
    {
        ...
        public const string CreatedCloudEventType = "google.cloud.datafusion.instance.v1.created";

        /// <summary>CloudEvent type for the 'deleted' event.</summary>
        public const string DeletedCloudEventType = "google.cloud.datafusion.instance.v1.deleted";

        /// <summary>CloudEvent type for the 'updated' event.</summary>
        public const string UpdatedCloudEventType = "google.cloud.datafusion.instance.v1.updated";
