...
{    
    ...
    public partial class InstanceEventData
    {
        ...
        public const string CreatedCloudEventType = "google.cloud.notebooks.instance.v1.created";

        /// <summary>CloudEvent type for the 'deleted' event.</summary>
        public const string DeletedCloudEventType = "google.cloud.notebooks.instance.v1.deleted";
