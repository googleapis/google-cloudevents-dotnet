...
{    
    ...
    public partial class InstanceEventData
    {
        ...
        public const string CreatedCloudEventType = "google.cloud.apigeeregistry.instance.v1.created";

        /// <summary>CloudEvent type for the 'deleted' event.</summary>
        public const string DeletedCloudEventType = "google.cloud.apigeeregistry.instance.v1.deleted";
