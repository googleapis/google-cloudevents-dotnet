...
{    
    ...
    {
        /// <summary>The name of the service which triggered the Cloud Audit log entry.</summary>
        ...
        /// <summary>The name of the method (RPC) triggering the Cloud Audit log entry.</summary>
        ...
        /// <summary>The name of the resource that is the subject of the Cloud Audit log entry.</summary>
