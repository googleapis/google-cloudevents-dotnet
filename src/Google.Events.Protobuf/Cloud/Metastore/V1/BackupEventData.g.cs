...
{    
    ...
    public partial class BackupEventData
    {
        ...
        public const string CreatedCloudEventType = "google.cloud.metastore.backup.v1.created";

        /// <summary>CloudEvent type for the 'deleted' event.</summary>
        public const string DeletedCloudEventType = "google.cloud.metastore.backup.v1.deleted";
