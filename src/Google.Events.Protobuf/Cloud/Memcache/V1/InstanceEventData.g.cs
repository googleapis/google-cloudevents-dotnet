...
{    
    ...
    public partial class InstanceEventData
    {
        ...
        public const string CreatedCloudEventType = "google.cloud.memcache.instance.v1.created";

        /// <summary>CloudEvent type for the 'updated' event.</summary>
        public const string UpdatedCloudEventType = "google.cloud.memcache.instance.v1.updated";

        /// <summary>CloudEvent type for the 'deleted' event.</summary>
        public const string DeletedCloudEventType = "google.cloud.memcache.instance.v1.deleted";
