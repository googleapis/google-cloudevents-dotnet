...
{    
    ...
    public partial class JobEventData
    {
        ...
        public const string CreatedCloudEventType = "google.cloud.scheduler.job.v1.created";

        /// <summary>CloudEvent type for the 'updated' event.</summary>
        public const string UpdatedCloudEventType = "google.cloud.scheduler.job.v1.updated";

        /// <summary>CloudEvent type for the 'deleted' event.</summary>
        public const string DeletedCloudEventType = "google.cloud.scheduler.job.v1.deleted";
