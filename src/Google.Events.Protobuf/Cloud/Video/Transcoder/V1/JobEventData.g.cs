...
{    
    ...
    public partial class JobEventData
    {
        ...
        public const string CreatedCloudEventType = "google.cloud.video.transcoder.job.v1.created";

        /// <summary>CloudEvent type for the 'deleted' event.</summary>
        public const string DeletedCloudEventType = "google.cloud.video.transcoder.job.v1.deleted";
