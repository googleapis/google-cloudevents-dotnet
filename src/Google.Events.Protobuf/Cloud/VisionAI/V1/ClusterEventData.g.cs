...
{    
    ...
    public partial class ClusterEventData
    {
        ...
        public const string CreatedCloudEventType = "google.cloud.visionai.cluster.v1.created";

        /// <summary>CloudEvent type for the 'updated' event.</summary>
        public const string UpdatedCloudEventType = "google.cloud.visionai.cluster.v1.updated";

        /// <summary>CloudEvent type for the 'deleted' event.</summary>
        public const string DeletedCloudEventType = "google.cloud.visionai.cluster.v1.deleted";
