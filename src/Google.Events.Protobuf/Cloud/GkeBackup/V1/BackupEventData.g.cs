...
{    
    ...
    public partial class BackupEventData
    {
        ...
        public const string CreatedCloudEventType = "google.cloud.gkebackup.backup.v1.created";

        /// <summary>CloudEvent type for the 'updated' event.</summary>
        public const string UpdatedCloudEventType = "google.cloud.gkebackup.backup.v1.updated";

        /// <summary>CloudEvent type for the 'deleted' event.</summary>
        public const string DeletedCloudEventType = "google.cloud.gkebackup.backup.v1.deleted";
